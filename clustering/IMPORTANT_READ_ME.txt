...
This is different to the way Sam's data is strcutured, as he leaves the 23h and 25h days in the table. Using that data would require a query approach rather than a slice one.
